...
public class DatabaseUtils {
	public static void setupDefaultDatabase() {
		try {
			String tablePrefix = Main.config.getString(ConstantsUtils.CONF_DB_PREFIX);
	...
	public static void setupPlayer(Player player) {
		try {
			...
			playerStmt.setDouble(2, Main.config.getDouble(ConstantsUtils.CONF_BALANCE_DEFAULT));
